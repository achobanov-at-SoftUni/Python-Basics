...
for male in boys:
    ...
    for female in girls:
        ...
        if interests_female & interests_male > matches:
            matches = len(interests_female & interests_male)
                male[matches] = female #?? Adding key and value to our existing lists. Compare then later
            break
